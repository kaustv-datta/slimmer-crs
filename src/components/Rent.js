...
import { pledgeValue, calculatePrePaymentRequired } from '../logic/Rules';
...
const Rent = ({
  ...
  const paymentNeeded =
    calculatePrePaymentRequired(customer?.type, hours, car?.type, car?.subType)
      ?.pledge - customer?.balance;
      ...
      <Modal.Body>
        <Form>
          ...
          <Form.Group controlId="formGroup-payment-needed">
            <Form.Label>Payment Required (before trip)</Form.Label>
            <Form.Control
              type="text"
              disabled
              value={
